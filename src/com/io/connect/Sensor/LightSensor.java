...
public class LightSensor extends javax.swing.JFrame {
    ...
    public LightSensor() {
        ...
        Thread task = new Thread() {
            @Override
            public void run() {
                System.out.println("******LOG LIGHT SENSOR********");
                while (true) {
                    try {
                        ...
                        if (myMsg[0].equals("DESKTOP") && myMsg[1].equals("LIGHT")) {
                            switch (myMsg[2]) {
                                case "ON":
                                    ...
                                    txt.append(msgBack + "\n");
                                    SocketConectorSensor.getSocketConector().sendMessage(MessageResponse.LIGHT_ON);
                                    break;
                                case "OFF":
                                    System.out.println("----OFF----");
                                    System.out.println(msgBack );
                                    txt.append(msgBack + "\n");
                                    SocketConectorSensor.getSocketConector().sendMessage(MessageResponse.LIGHT_OFF);
                                    break;
                                default:
